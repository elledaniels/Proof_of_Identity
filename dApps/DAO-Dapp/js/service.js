...
//This function just creates the datebase if it is not exists yet
function createTheDBDAORolesAddress(msg){
	initsql = "CREATE TABLE IF NOT EXISTS `roleswalletaddress1` ( "
					+"  `id` IDENTITY PRIMARY KEY, "
